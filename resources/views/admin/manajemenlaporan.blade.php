...
<script>
    ...
    function updateButtonStates(val) {
        ...
        var isSpecificUser = val && val !== '';

        _userSelected = true;

        // Tampilkan: disable jika "Semua Pegawai" atau belum pilih
        btnTampilkan.disabled = !isSpecificUser;

        // PDF & Excel: aktif saat sudah pilih (termasuk "Semua Pegawai")
        btnPdf.style.opacity = '1'; btnPdf.style.pointerEvents = 'auto';
        btnExcel.style.opacity = '1'; btnExcel.style.pointerEvents = 'auto';
    }
